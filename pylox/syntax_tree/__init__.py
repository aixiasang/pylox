...
from pylox.syntax_tree.expr import Binary, Grouping, Literal, Unary, Variable, Assign, Logical, Call, Get, Set, This, Super, Lambda
...
__all__ = [
    ...
    'Call', 'Function', 'Return', 'Lambda', 'Get', 'Set', 'This', 'Super', 'Class'
]